...
export default function apiHandler (req, res) {
  ...
  if (url.pathname === '/components/manage-forms/disk-space-form.js') { return fileHandler('client/components/forms/manage-disk-space-form.js', 'application/javascript')(req, res) }
