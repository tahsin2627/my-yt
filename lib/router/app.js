...
export default function apiHandler (req, res) {
  ...
  if (url.pathname === '/components/add-channel-form.js') { return fileHandler('client/components/add-channel-form.js', 'application/javascript')(req, res) }
  if (url.pathname === '/components/manage-channels-form.js') { return fileHandler('client/components/manage-channels-form.js', 'application/javascript')(req, res) }
  if (url.pathname === '/components/video-quality-form.js') { return fileHandler('client/components/video-quality-form.js', 'application/javascript')(req, res) }
  ...
  if (url.pathname === '/components/manage-disk-space-form.js') { return fileHandler('client/components/manage-disk-space-form.js', 'application/javascript')(req, res) }
  if (url.pathname === '/components/transcode-videos-form.js') { return fileHandler('client/components/transcode-videos-form.js', 'application/javascript')(req, res) }
  if (url.pathname === '/components/excluded-terms-form.js') { return fileHandler('client/components/excluded-terms-form.js', 'application/javascript')(req, res) }
